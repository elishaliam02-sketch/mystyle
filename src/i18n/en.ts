...
export const en: typeof he = {
  ...
  focus: {
    ...
    autoOff: "Focus switches itself off after four hours, so you don't find a grey app tomorrow morning.",
  },
  ...
  improve: {
    ...
    water: "Water",
    waterLine: "{actual} glasses a day on average, target {target}.",
