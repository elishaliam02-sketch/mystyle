...
export const MEALS: Meal[] = [
  ...
  M("freekeh-veg-bowl",
    ...
    ["freekeh", "pumpkin", "chickpeas", "tahini"], "lunch", ["balanced", "veg"], 520, 18),
  M("labneh-pita",
    ...
    ["labneh", "pitaWhole", "cucumber", "oliveOil"], "breakfast", ["protein", "balanced"], 380, 18),
  M("kale-chickpea-salad",
    ...
    ["kale", "chickpeas", "lemon", "oliveOil", "almonds"], "lunch", ["veg", "light"], 420, 15),
  M("buckwheat-mushroom-egg",
    ...
    ["buckwheat", "mushroom", "egg", "onion"], "dinner", ["balanced", "protein"], 460, 20),
  M("salmon-asparagus-rice",
    ...
    ["salmon", "asparagus", "brownRice"], "dinner", ["protein", "hearty"], 560, 38),
  M("tempeh-stirfry",
    ...
    ["tempeh", "broccoli", "brownRice", "garlic"], "dinner", ["protein", "veg"], 500, 28),
  M("skyr-strawberries",
    ...
    ["skyr", "strawberries", "almonds"], "snack", ["protein", "light"], 300, 22),
  M("mackerel-toast",
    ...
    ["mackerel", "wholeBread", "arugula", "lemon"], "lunch", ["protein", "balanced"], 420, 28),
  M("kohlrabi-tahini-sticks",
    ...
    ["kohlrabi", "radish", "tahini"], "snack", ["light", "veg"], 180, 6),
  M("pumpkin-lentil-soup",
    ...
    ["pumpkin", "lentils", "onion", "oliveOil"], "dinner", ["hearty", "veg"], 420, 18),
  M("barley-chicken-bowl",
    ...
    ["barley", "chicken", "chard", "oliveOil"], "lunch", ["protein", "hearty"], 560, 40),
  M("kefir-flax-smoothie",
    ...
    ["kefir", "flaxseed", "berries", "banana"], "breakfast", ["light", "balanced"], 330, 14),
  M("fava-cilantro-salad",
    ...
    ["fava", "cilantro", "lemon", "oliveOil"], "lunch", ["veg", "light"], 320, 14),
  M("brussels-egg-bowl",
    ...
    ["brusselsSprouts", "egg", "oliveOil", "pumpkinSeeds"], "dinner", ["veg", "protein"], 380, 20),
];
