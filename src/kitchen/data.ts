...
export const MEALS: Meal[] = [
  ...
  M("mujadara",
    ...
    ["lentils", "rice", "onion", "oliveOil"], "dinner", ["hearty", "veg"], 520, 18),
  M("sabich-bowl",
    ...
    ["eggplant", "egg", "tahini", "tomato", "cucumber"], "lunch", ["balanced", "veg"], 470, 20),
  M("chicken-tzatziki-bowl",
    ...
    ["chicken", "brownRice", "cucumber", "greekYogurt", "lemon"], "lunch", ["protein", "hearty"], 580, 45),
  M("red-lentil-curry",
    ...
    ["lentils", "tomato", "onion", "garlic", "brownRice"], "dinner", ["hearty", "veg"], 510, 22),
  M("cottage-pasta",
    ...
    ["pasta", "cottage", "tomato", "garlic"], "dinner", ["protein", "hearty"], 540, 32),
  M("tuna-bean-salad",
    ...
    ["tuna", "beans", "onion", "parsley", "oliveOil"], "lunch", ["protein", "light"], 420, 34),
  M("sheetpan-chicken",
    ...
    ["chicken", "pepper", "zucchini", "potato", "oliveOil"], "dinner", ["protein", "hearty"], 590, 42),
  M("salmon-tomato-skillet",
    ...
    ["salmon", "tomato", "garlic", "spinach"], "dinner", ["protein", "balanced"], 520, 38),
  M("chickpea-spinach-stew",
    ...
    ["chickpeas", "spinach", "tomato", "onion"], "dinner", ["veg", "hearty"], 430, 20),
  M("yogurt-kiwi-walnut",
    ...
    ["greekYogurt", "kiwi", "walnuts", "honey"], "snack", ["protein", "light"], 330, 22),
  M("turkey-hummus-wrap",
    ...
    ["tortilla", "hummusSpread", "turkey", "lettuce", "tomato"], "lunch", ["protein", "balanced"], 460, 34),
  M("sweet-potato-cottage",
    ...
    ["sweetPotato", "cottage", "oliveOil"], "lunch", ["balanced", "veg"], 400, 22),
  M("tofu-buckwheat-stirfry",
    ...
    ["tofu", "broccoli", "buckwheat", "garlic"], "dinner", ["protein", "veg"], 490, 28),
  M("overnight-oats-skyr",
    ...
    ["oats", "skyr", "berries", "chia"], "breakfast", ["protein", "balanced"], 420, 28),
  M("barley-pepper-salad",
    ...
    ["barley", "pepper", "feta", "parsley", "oliveOil"], "lunch", ["balanced", "veg"], 480, 17),
  M("sardines-toast",
    ...
    ["sardines", "wholeBread", "tomato", "lemon"], "lunch", ["protein", "light"], 380, 26),
];
