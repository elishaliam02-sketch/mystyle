...
export const MEALS: Meal[] = [
  ...
  M("chickpea-quinoa",
    ...
    ["quinoa", "chickpeas", "spinach", "lemon"], "lunch", ["veg", "protein", "hearty"], 440, 20, "quinoa salad chickpeas"),
  M("apple-pb",
    ...
    ["apple", "peanutButter"], "snack", ["balanced"], 200, 6, "apple slices peanut butter"),
  M("yogurt-berries",
  ...
  M("nuts-banana",
    ...
    ["banana", "nuts"], "snack", ["hearty", "balanced"], 260, 7, "banana and nuts"),
  ...
  M("chia-pudding",
    ...
    ["chia", "milk", "berries"], "breakfast", ["light", "balanced"], 240, 10, "chia pudding"),
  M("bagel-cheese",
  ...
  M("omelette-mushroom",
    ...
    ["egg", "mushroom", "onion", "yellowCheese"], "dinner", ["protein"], 380, 24, "mushroom omelette"),
  M("edamame-rice",
  ...
  M("pear-cheese",
    ...
    ["pear", "whiteCheese"], "snack", ["light"], 190, 10, "pear cheese"),
  ...
  M("kohlrabi-tahini-sticks",
    ...
    ["kohlrabi", "radish", "tahini"], "snack", ["light", "veg"], 180, 6, "kohlrabi sticks tahini"),
  ...
  M("kefir-flax-smoothie",
    ...
    ["kefir", "flaxseed", "berries", "banana"], "breakfast", ["light", "balanced"], 330, 14, "kefir smoothie glass"),
  ...
  M("salmon-tomato-skillet",
    ...
    ["salmon", "tomato", "garlic", "spinach"], "dinner", ["protein", "balanced"], 520, 38, "salmon tomato sauce pan"),
