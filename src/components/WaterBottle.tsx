...
type Props = {
  ...
  width?: number;
  height?: number;
  /** Draw for a dark hero surface: translucent-white water and a white glass,
   * instead of the red-on-paper look. */
  onHero?: boolean;
};
 ...
 */
export function WaterBottle({ fill, met, width = 74, height = 150, onHero = false }: Props) {
      ...
      <Svg width={width} height={height} viewBox="0 0 100 200">
        <Defs>
          <LinearGradient id="water" x1="0" y1="0" x2="0" y2="1">
            <Stop offset="0" stopColor={waterColor} stopOpacity={topO} />
            <Stop offset="1" stopColor={waterColor} stopOpacity={botO} />
          </LinearGradient>
        ...
        />
        {/* cap */}
        <Rect x={38} y={2} width={24} height={10} rx={3} fill={glassColor} />
      </Svg>
    </View>
  );
}
